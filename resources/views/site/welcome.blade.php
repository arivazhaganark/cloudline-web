    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-5 home-txt1">
                ...
                <p> <a href="{{ url('video_conferencing') }}" class="btn btn1 "> Explore More <i class="fas fa-arrow-right"></i></a></p>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-5 home-txt1 home-txt2">
                ...
                <br/>
                <p> <a href="{{ url('key_features') }}" class="btn btn1 ">Know More <i class="fas fa-arrow-right"></i></a></p>
            </div>
        </div>
    </div>
</section>
