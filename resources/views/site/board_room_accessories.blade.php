          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              <div class="row row-eq-height">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 pro">
                  <div class="product-thumb">
                    <p> <img src="images/board-pro3.jpg" alt=""></p>
                    <h4> Snap </h4>
                     <p class="pro-subname"> <span> Wide angle USB Camera</span> </p>
                    <div class="product-desciption text-center eq-h1"> Snap HD Camera is equipped with 1080p resolution and 120° wide range shooting angle. It is suitable for different sizes of conference meeting for business. </div>
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
              <div class="row row-eq-height">
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 pro">
                  <div class="product-thumb">
                    <p> <img src="images/board-pro6.jpg" alt=""></p>
                    <h4> A/V HUB </h4>
                    <p> <span> ET-510 </span> </p>
                    <div class="product-desciption text-center"> The Multi-I/O Converter Box 510 is the hub that unites your A/V devices. Simply connect your notebook, tablet, Blu-ray player, and many more to this hub, and just within minutes, all the video content will be at your service in Full HD quality. </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 pro">
                  <div class="product-thumb">
                    ...
                    <h4> VIDA </h4>
                    <p> <span> VIDA </span> </p>
                    <div class="product-desciption text-center"> Professional Seamless video switcher & scaler with multiple analog/Digital interfaces. </div>
                    <p> <a href="{{ url('contactus') }}" class="btn btn1 "> Buy now <i class="fas fa-arrow-right"></i></a></p>
                  </div>
                </div>
              </div>
